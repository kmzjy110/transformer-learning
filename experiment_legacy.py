...
if __name__ == '__main__':
    ...
    experiment.train(steps=args.num_steps, batch_size=32,
                     final_model_state_dict=torch.load('experiments/exp_num_letters=26_num_numbers=26_embedding_dim=512_num_heads=2_num_layers=2_num_training_data=None_number_symbolic_rep=True_seed=6/final_model.pt'))
